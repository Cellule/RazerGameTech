...
bool CIniFileA::GetKeyValue( const std::string& sSection, const std::string& sKey, std::string& sValue) const
{
#ifdef _CINIFILE_DEBUG
    std::cout <<  "CIniFileA::GetKeyValue()" << std::endl;
#endif
    CIniSectionA* pSec = GetSection( sSection );
    return !!pSec && pSec->GetKeyValue(sKey,sValue);
}
...
bool CIniSectionA::GetKeyValue( const std::string& sKey, std::string& sValue ) const
{
#ifdef _CINIFILE_DEBUG
