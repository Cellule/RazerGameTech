...
public:
    ...
    public:
        ...
        bool GetKeyValue( const std::string& sKey, std::string& sValue ) const;
...
public:
    ...
    // Returns a KeyValue at a certain section
    bool GetKeyValue( const std::string& sSection, const std::string& sKey, std::string& sValue) const;
    // Sets a KeyValuePair at a certain section
